...
const WORKFLOW_GROUPS: Array<{ workflow: string; name: string }[]> = [
  ...
  [
    ...
    { workflow: "refresh-finnhub-technical-advisory.yml", name: "Finnhub Advisory" },
    { workflow: "refresh-finnhub-support-resistance.yml", name: "Finnhub S/R" },
    { workflow: "refresh-finnhub-metrics.yml",          name: "Finnhub Metrics" },
